...
public final class Calc {
   ...
   * @return -1, if v2 is null but not v1, 1 for vice versa, 0 for both being null, and for when neither is null.
   * @return -1, if v2 is null but not v1, 1 for vice versa, 0 for both being null, and NONENULL for when neither is null.
   */
